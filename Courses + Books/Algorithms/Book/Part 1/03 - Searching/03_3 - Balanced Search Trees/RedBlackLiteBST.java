 ...
 *  Data files:   <a href="https://algs4.cs.princeton.edu/33balanced/tinyST.txt">https://algs4.cs.princeton.edu/33balanced/tinyST.txt</a>
 *
...
public class RedBlackLiteBST<Key extends Comparable<Key>, Value> {
    ...
    public static void main(String[] args) {
        ...
        RedBlackLiteBST<String, Integer> st = new RedBlackLiteBST<>();
        ...
        RedBlackLiteBST<Integer, Integer> st2 = new RedBlackLiteBST<>();
        for (int i = 0; i < n; i++) {
            st2.put(i, i);
            int h = st2.height();
